...
def planner_brief(proposal: str, graph: dict) -> str:
    ...
    return "\n".join([
        ...
        "files: at most 5 repo-relative paths — the ones the change MUST edit, comma-separated",
        ...
        "",
        "Keep the whole handoff under 15 lines. A list of every file that might be",
